...
import './HomeTutorCourseManagement.css'

const HomeTutorCourseManagement = () => {
  ...
  return (
    ...
    <div id="student-exam-course-management">
      ...
      <div id="course-manag-all-checks-box">
        ...
        <div className="home-tutor-checks-btns-box">
          <button type='submit' className='ht-cb-submit'>Submit</button>
          <button type='cancel' className='ht-cb-cancel'>Cancel</button>
        </div>
...
export default HomeTutorCourseManagement;
